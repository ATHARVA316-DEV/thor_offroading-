...
class AssetGenerator:
    ...
    def _create_directories(self) -> None:
        ...
        print(f"✓ Created {len(self.config.FOLDERS)} output directories")
    ...
    def _load_fonts(self) -> None:
        ...
        try:
            ...
            print(f"✓ Loaded font: {self.config.FONT_NAME}")
        except (OSError, IOError):
            print(f"⚠ Font '{self.config.FONT_NAME}' not found, using default")
